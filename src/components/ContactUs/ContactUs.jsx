...
const ContactUs = () => {
    return (
        <div>
<h1 className='text-5xl font-bold text-center mb-8 mt-16'>Contact us</h1>
<section className="bg-gray-100  rounded-lg">
    <div className="container px- pb-12 pt-8 mx-auto">
        <div>
            {/* <p className="font-medium text-blue-500 dark:text-blue-400">Contact us</p> */}

            <h1 className="mt-2 text-2xl font-semibold text-center">Get in touch</h1>

            <p className="mt-3 text-gray-500 dark:text-gray-400 text-center">Our friendly team would love to hear from you.</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
            <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                <div className="text-center md:text-left">
                    ...
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">hello@brandscar.com</p>
                </div>
                ...
                <div className="text-center md:text-left">
                    ...
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">100 Smith Street Collingwood VIC 3066 Izmir</p>
                </div>
