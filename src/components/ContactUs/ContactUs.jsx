const ContactUs = () => {
  return (
    <div>
      ...
      <h1 className="text-5xl font-bold text-center pt-10 ">Contact us</h1>
        <div className="container px- pb-12 pt-8 mx-auto">
          ...
          <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3 px-8">
            <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1 ">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">
                  100 Smith Street Collingwood VIC 3066 Izmir
                </p>
              </div>
